...
public static class Move
{
    ...
    public static MoveData ViceGrip = new(
        ...
        55, 100, 0,
        MoveEffect.Hit, 0,
        true, Target.Opponent + Target.Ally, 30,
        MoveFlags.makesContact); //Needs anim
    public static MoveData Guillotine = new(
        "Guillotine", Type.Normal,
        1, 30, 0,
        MoveEffect.OHKO, 0,
        true, Target.Opponent + Target.Ally, 5,
        MoveFlags.makesContact); //Needs anim
    ...
    public static MoveData Gust = new(
        ...
        40, 100, 0,
        MoveEffect.Hit, 0,
        false, Target.Opponent + Target.Ally, 35,
    ...
    public static MoveData Whirlwind = new(
        ...
        false, Target.Opponent + Target.Ally, 20); //Needs anim
    ...
    public static MoveData PoisonSting = new(
        ...
        true, Target.Opponent + Target.Ally, 35); //Needs anim
    ...
    public static MoveData Ember = new(
        ...
        40, 100, 0,
        MoveEffect.Burn, 10,
        false, Target.Opponent + Target.Ally, 25); //Needs anim
    ...
    public static MoveData HydroPump = new(
        ...
        110, 80, 0,
        MoveEffect.Hit, 0,
        false, Target.Opponent + Target.Ally, 5); //Needs anim
    public static MoveData Surf = new(
        "Surf", Type.Water,
        90, 100, 0,
        MoveEffect.Hit, 0,
        false, Target.Opponent + Target.Ally + Target.Spread, 15); //Needs anim
    public static MoveData IceBeam = new(
        "Ice Beam", Type.Ice,
        90, 100, 0,
        MoveEffect.Freeze, 10,
        false, Target.Opponent + Target.Ally, 10); //Needs anim
    ...
    public static MoveData Absorb = new(
        ...
        false, Target.Opponent + Target.Ally, 25,
    ...
    public static MoveData RazorLeaf = new(
        ...
        55, 95, 0,
        MoveEffect.Hit, 0,
        true, Target.Opponent + Target.Spread, 25, MoveFlags.highCrit); //Needs anim
    ...
    public static MoveData ThunderShock = new(
        ...
        40, 100, 0,
        MoveEffect.Paralyze, 10,
        false, Target.Opponent + Target.Ally, 30); //Needs anim
    ...
    public static MoveData Thunder = new(
        ...
        110, 70, 0,
        MoveEffect.Paralyze, 30,
        false, Target.Opponent + Target.Ally, 10, MoveFlags.alwaysHitsInRain); //Needs anim
    ...
    public static MoveData Earthquake = new(
        ...
        100, 100, 0,
        MoveEffect.Hit, 0,
        true, Target.Opponent + Target.Ally, 10, MoveFlags.hitDiggingMon); //Needs anim
    public static MoveData Fissure = new(
        "Fissure", Type.Ground,
        1, 30, 0,
        MoveEffect.OHKO, 0,
        true, Target.Opponent + Target.Ally, 5); //Needs anim
    ...
    public static MoveData Screech = new(
        ...
        false, Target.Opponent + Target.Ally, 40,
        MoveFlags.soundMove); //Needs anim
    ...
    public static MoveData Transform = new(
        ...
        false, Target.Opponent + Target.Ally, 10,
        MoveFlags.cannotMimic); //Needs anim
    ...
    public static MoveData Explosion = new(
        ...
        250, 100, 0,
        MoveEffect.SelfDestruct, 0,
        true, Target.Opponent + Target.Ally
    ...
    public static MoveData Sketch = new(
         ...
         0, 101, 0,
         MoveEffect.Sketch, 0,
         false, Target.Opponent + Target.Ally, 1); //Needs anim
    ...
    public static MoveData FlameWheel = new(
        ...
        60, 100, 0,
        MoveEffect.Burn, 10,
        true, Target.Opponent + Target.Ally, 25); //Needs anim
    ...
    public static MoveData Aeroblast = new(
        ...
        100, 95, 0,
        MoveEffect.Hit, 0,
        false, Target.Opponent + Target.Ally, 5,
    ...
    public static MoveData Protect = new(
        ...
        false, Target.Self, 10,
        MoveFlags.usesProtectCounter); //Needs anim
    public static MoveData MachPunch = new(
        "Mach Punch", Type.Fighting,
        40, 100, 1,
        MoveEffect.Hit, 0,
        true, Target.Opponent + Target.Ally, 30); //Needs anim
    ...
    public static MoveData Foresight = new(
        ...
        false, Target.Opponent + Target.Ally, 40); //Needs anim
    ...
    public static MoveData FalseSwipe = new(
        ...
        true, Target.Opponent + Target.Ally, 40); //Needs anim
    ...
    public static MoveData Spark = new(
        ...
        65, 100, 0,
        MoveEffect.Paralyze, 30,
        true, Target.Opponent + Target.Ally, 20); //Need anim
    ...
    public static MoveData RapidSpin = new(
        ...
        true, Target.Opponent + Target.Ally, 40,
        MoveFlags.effectOnSelfOnly); //Needs anim
    ...
    public static MoveData SolarBeamAttack = new(
        ...
        120, 100, 0,
        MoveEffect.Hit, 0,
        false, Target.Opponent + Target.Ally, 0,
    ...
    public static MoveData Struggle = new(
        ...
        true, Target.Opponent + Target.Ally, 0,
