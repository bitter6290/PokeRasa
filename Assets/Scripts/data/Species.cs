...
public static class Species
{
    public static SpeciesData Missingno = new(
        ...
        new Ability[] { Ability.None, Ability.None, Ability.None },
    ...
    public static SpeciesData Bulbasaur = new(
        ...
        new Ability[] { Ability.Overgrow, Ability.Overgrow, Ability.Chlorophyll },
    ...
    public static SpeciesData Charmander = new(
        ...
        new Ability[] { Ability.Blaze, Ability.Blaze, Ability.SolarPower },
    ...
    public static SpeciesData Squirtle = new(
        ...
        new Ability[] { Ability.Torrent, Ability.Torrent, Ability.RainDish },
        "squirtle", "squirtle", 9);
