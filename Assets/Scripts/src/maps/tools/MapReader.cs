...
public static class MapReader
{
...
#if UNITY_EDITOR
    public static Tileset collisionTiles = Resources.Load<Tileset>("Tilesets/Collision");
    public static void RenderNeighborsForEditingV1(MapHelper mapHelper)
    {
            ...
            switch (i.direction)
            {
                case Direction.N:
                    for (int x = 0; x < connectedMap.width; x++)
                    {
                        ...
                        {
                            int offset = (x * connectedMap.height + y) * 26 + 2;
                            level1.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset] + (connectionData[offset + 1] * 256)]);
                            level2.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 2] + (connectionData[offset + 3] * 256)]);
                            level3.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 4] + (connectionData[offset + 5] * 256)]);
                            level1.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 6] + (connectionData[offset + 7] * 256)]);
                            level2.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 8] + (connectionData[offset + 9] * 256)]);
                            level3.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 10] + (connectionData[offset + 11] * 256)]);
                            level1.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 12] + (connectionData[offset + 13] * 256)]);
                            level2.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 14] + (connectionData[offset + 15] * 256)]);
                            level3.SetTile(new Vector3Int(2 * (x + i.offset), 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 16] + (connectionData[offset + 17] * 256)]);
                            level1.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 18] + (connectionData[offset + 19] * 256)]);
                            level2.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 20] + (connectionData[offset + 21] * 256)]);
                            level3.SetTile(new Vector3Int(2 * (x + i.offset) + 1, 2 * y + 1 + (2 * mapHelper.OpenMap.height)),
                                currentTiles.Tiles[connectionData[offset + 22] + (connectionData[offset + 23] * 256)]);
                        }
                    }
                    break;
                ...
                case Direction.E:
                    for (int x = 0; x < connectedMap.width; x++)
                    {
                        ...
                        {
                            int offset = (x * connectedMap.height + y) * 26 + 2;
                            level1.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset] + (connectionData[offset + 1] * 256)]);
                            level2.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset + 2] + (connectionData[offset + 3] * 256)]);
                            level3.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset + 4] + (connectionData[offset + 5] * 256)]);
                            level1.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset + 6] + (connectionData[offset + 7] * 256)]);
                            level2.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset + 8] + (connectionData[offset + 9] * 256)]);
                            level3.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset)),
                                currentTiles.Tiles[connectionData[offset + 10] + (connectionData[offset + 11] * 256)]);
                            level1.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 12] + (connectionData[offset + 13] * 256)]);
                            level2.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 14] + (connectionData[offset + 15] * 256)]);
                            level3.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width), 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 16] + (connectionData[offset + 17] * 256)]);
                            level1.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 18] + (connectionData[offset + 19] * 256)]);
                            level2.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 20] + (connectionData[offset + 21] * 256)]);
                            level3.SetTile(new Vector3Int(2 * x + (2 * mapHelper.OpenMap.width) + 1, 2 * (y + i.offset) + 1),
                                currentTiles.Tiles[connectionData[offset + 22] + (connectionData[offset + 23] * 256)]);
                        }
                    }
                    break;
        ...
        for (int i = -30; i < (mapHelper.OpenMap.width * 2) + 30; i++)
        {
            for (int j = -30; j < (mapHelper.OpenMap.height * 2) + 30; j++)
            {
                Vector3Int pos = new(i, j);
                if ((level1.GetTile(pos), level2.GetTile(pos), level3.GetTile(pos)) is (null, null, null))
                {
                    Metatiles.MapTile mapTile = mapHelper.OpenMap.boundary.GetTile(new(i, j));
                    level1.SetTile(pos, mapTile.level1);
                    level2.SetTile(pos, mapTile.level2);
                    level3.SetTile(pos, mapTile.level3);
                }
    ...
    public static void ClearConnections(MapHelper mapHelper)
    {
        for (int x = mapHelper.level1.cellBounds.min.x; x < mapHelper.level1.cellBounds.max.x; x++)
        {
            ...
            {
                if (x >= 0 && x < mapHelper.OpenMap.width * 2 && y >= 0 && y < mapHelper.OpenMap.height * 2) continue;
    ...
    public static void ReadForEditingV1(MapHelper mapHelper)
    {
        ...
        string inString = mapHelper.OpenMap.MapTiles.Replace("?", "AAAA").Replace("@", "AA").Replace("&", "AAAAAAA").Replace("^", "AAAAAA");
        Debug.Log(inString.Length);
        byte[] data = System.Convert.FromBase64String(inString);
        ...
        for (int x = 0; x < mapHelper.OpenMap.width; x++)
        {
            ...
            {
                int offset = (x * mapHelper.OpenMap.height + y) * 26 + 2;
                level1.SetTile(new Vector3Int(2 * x, 2 * y),
                    currentTiles.Tiles[data[offset] + (data[offset + 1] * 256)]);
                level2.SetTile(new Vector3Int(2 * x, 2 * y),
                    currentTiles.Tiles[data[offset + 2] + (data[offset + 3] * 256)]);
                ...
                collision.SetTile(new Vector3Int(x, y),
                    collisionTiles.Tiles[data[offset + 24]]);
                wildData.SetTile(new Vector3Int(x, y),
                    collisionTiles.Tiles[data[offset + 25]]);
    ...
    public static void CreateNewMapV1(MapHelper mapHelper)
    {
        ...
        for (int x = 0; x < mapHelper.OpenMap.width; x++)
        {
            for (int y = 0; y < mapHelper.OpenMap.height; y++)
            {
                ...
                collision.SetTile(new Vector3Int(x, y),
                    collisionTiles.Tiles[(int)CollisionID.Level3]);
                wildData.SetTile(new Vector3Int(x, y),
                    collisionTiles.Tiles[(int)CollisionID.Impassable]);
            }
        }
        RenderNeighborsForEditingV1(mapHelper);
