...
public static class CharGraphics
{
    ...
    public static HumanoidGraphics HumanoidFromStandardImage(Texture2D texture) => texture.width switch
    {
        144 => new()
        {
        ...
        64 => new()
        {
            ...
            stillWest = SpriteFromTexture16x32(texture, 2),
            stillEast = SpriteFromTexture16x32(texture, 2),
            walkNorthL = SpriteFromTexture16x32(texture, 3), //Bowing sprite
        },
        _ => throw new System.Exception("Used wrong size image as HumanoidGraphics")
    };
